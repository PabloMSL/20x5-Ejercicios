...
if recomendaciones:
    for categoria, recomendadores in recomendaciones.items():
        print(f"\nCategoría: {categoria}")
        for recomendador, similitud in recomendadores:
            print(f" - Recomendado por {recomendador} ({similitud * 100:.0f}% similar)")
else:
    print("No hay recomendaciones basadas en usuarios similares.")